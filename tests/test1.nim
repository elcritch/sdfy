...
let testModes* = [
  ...
  (mode: sdfModeClipBgrSubPixelAA, name: "clip_bgr_sub_pixel_aa", factor: 4.0, spread: 0.0, posColor: pos, negColor: neg),
  ...
  (mode: sdfModeAnnularBgrSubPixelAA, name: "annular_bgr_sub_pixel_aa", factor: 4.0, spread: 0.0, posColor: pos, negColor: neg),
  ...
  (mode: sdfModeDropShadowAA, name: "drop_shadow_aa", factor: 10.0, spread: 20.0, posColor: pos, negColor: pos),
